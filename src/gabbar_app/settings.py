"""
Django settings for gabbar_app project.
...
SECRET_KEY = 'u4p3c45n^g3jkqaai&1q^pakq!)w!5hx&$vk-q09l3ow^suh^a'
...
WSGI_APPLICATION = 'gabbar_app.wsgi.application'
...
POSTGRES_APP_DB_USER = 'ekluv'
POSTGRES_APP_DB_PASSWORD = 'ekluv'
POSTGRES_APP_DB_NAME = 'gabbar_db'
